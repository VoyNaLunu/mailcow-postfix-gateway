...
modify_relay_config "mynetworks" "${MAILCOW_IPV4_NETWORK:-172.22.1.0/24} ${MAILCOW_IPV6_NETWORK:-fd4d:6169:6c63:6f77::/64} ${GATEWAY_WG_NETWORK:-100.64.0}.0/24 127.0.0.0/8"
